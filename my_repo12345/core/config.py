...
from .my_repo12345 import DollyDollyException
...
class DollyDollyConf(object):

    def __init__(self, conf):
        try:
            conf = json.loads(conf)
        except ValueError as msg:
            raise DollyDollyException('Unable to parse DollyDolly configuration: %s' % msg)
        self.my_repo12345 = AttributeTree(conf)
